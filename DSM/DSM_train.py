...
def homography_model():
    ...
    #added another convolution layer pair
    model.add(layers.Conv2D(128, kernel_size=(3, 3), strides=(1, 1), padding='same', name='conv9', activation='relu'))
    model.add(layers.Conv2D(128, kernel_size=(3, 3), strides=(1, 1), padding='same', name='conv10', activation='relu'))   
...
if __name__ == "__main__":
    ...
    EPOCHS = 1000        # Set EPOCHS and BS intuitively. Typically train for 1000 to 2000 epochs
    BS = 16
    ...
    checkpoint= ModelCheckpoint('DSM_weights_24sept_256both.hdf5', monitor='loss', verbose=1, save_best_only=True, mode='min')
